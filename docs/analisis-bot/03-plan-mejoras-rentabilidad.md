...
**Hecho: 18/22** (T8 + T9 + T13 paso 1 + T14 + T15 + T16 + T17 + T18 + T22). Próximo bloque recomendado: **T13 paso 2** (degradar LLM, tras 2–4 sem de datos en `bot_health_events`). T11 queda a la espera de T13 paso 2.
